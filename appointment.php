...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate fields
    if (empty($name) || empty($mobile) || empty($services)   || empty($message) || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    try {
        ...
        $mail->Subject = "New Enquiry for " . $services;
        $mail->Body = '<html>
        <head>
            <style>
        ...
        <body>
            <div class="container">
                ...
                <p><span class="label">Subject:</span> <span class="value">' . $services . '</span></p>
